...
const db = require("quick.db");
 ...
 if(!message.mentions.users.first()) return message.channel.send(`Pls mention someone`)
    ...
    tic.init({ PROVIDE_MEMBER: "Please provide a  member", ACCEPT_CHALLENGE: "{user} type yes in this chat", DOESNT_PLAY: "looks like {user} doesnt wanna play", WICH_SIDE: "**{user}, Which Side Do You Pick? Type \`End\` To End the game!**", GAME_OVER: "Times up!", END: "end", INACTIVITY: "game ended due to inactivity!", WINNER: "Congrats u have won {winner} ", DRAW: "Its a draw"})
        }
            }
